  ...
  return (
    <div className="App">
      ...
      <div className='mt-[80px] flex flex-col items-center w-full font-link bg-[#EEEEFF] min-h-screen'>
        ...
        <div className='z-10 rounded-3xl bg-[#FFFFFF] drop-shadow-xl flex flex-row justify-between items-center w-11/12 p-[5px] px-[15px] m-3 fixed bottom-4'>
          <form className="w-full flex flex-row justify-between items-center">
            <label className="w-full">
              <div className="w-full"><input disabled={disable ? "disabled" : ""} className="w-full border-b-2 focus:outline-none text-sm" type="text" placeholder={placeholder} value={post} onChange={handleChange}></input></div>
            </label>
